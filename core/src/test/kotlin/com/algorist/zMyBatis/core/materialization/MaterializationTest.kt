...
class MaterializationTest {
    ...
    @Test
    fun postgresqlByteBindingsMaterializeAtSigned8BitBoundaries() {
        val execution = success(
            MaintainedExecutionMaterializer.materialize(
                prepared(
                    sql = "select ?, ?",
                    bindings = listOf(
                        byteBinding(0, BigInteger.valueOf(Byte.MIN_VALUE.toLong())),
                        byteBinding(1, BigInteger.valueOf(Byte.MAX_VALUE.toLong())),
                    ),
                ),
                TargetDialectIdentity("postgresql"),
            ),
        ...
        assertEquals(
            "select CAST(-128 AS SMALLINT), CAST(127 AS SMALLINT)",
            execution.executionSql,
        )
    }

    @Test
    fun explicitTinyintJdbcTypeIsAdmitted() {
        val execution = success(
            MaintainedExecutionMaterializer.materialize(
                prepared(
                    sql = "select ?",
                    bindings = listOf(byteBinding(0, BigInteger.valueOf(42), jdbcType = "TINYINT")),
                ),
                TargetDialectIdentity("postgresql"),
            ),
        )

        assertEquals("select CAST(42 AS SMALLINT)", execution.executionSql)
    }

    @Test
    fun mixedBigintByteSmallintIntegerAndBooleanBindingsPreserveOrderAndFingerprintIdentity() {
        val first = success(
            MaintainedExecutionMaterializer.materialize(
                prepared(
                    sql = "select ?, ?, ?, ?, ?",
                    bindings = listOf(
                        longBinding(0, BigInteger.valueOf(41)),
                        byteBinding(1, BigInteger.valueOf(42)),
                        smallintBinding(2, BigInteger.valueOf(43)),
                        integerBinding(3, BigInteger.valueOf(44)),
                        booleanBinding(4, true),
                    ),
                ),
                TargetDialectIdentity("postgresql"),
            ),
        ...
        val second = success(
            MaintainedExecutionMaterializer.materialize(
                prepared(
                    ...
                    bindings = listOf(
                        longBinding(0, BigInteger.valueOf(41)),
                        byteBinding(1, BigInteger.valueOf(45)),
                        smallintBinding(2, BigInteger.valueOf(43)),
                        integerBinding(3, BigInteger.valueOf(44)),
                        booleanBinding(4, true),
                    ),
        ...
        assertEquals(
            "select CAST(41 AS BIGINT), CAST(42 AS SMALLINT), CAST(43 AS SMALLINT), " +
                "CAST(44 AS INTEGER), CAST(TRUE AS BOOLEAN)",
            first.executionSql,
        )
        assertEquals(
            "select CAST(41 AS BIGINT), CAST(45 AS SMALLINT), CAST(43 AS SMALLINT), " +
                "CAST(44 AS INTEGER), CAST(TRUE AS BOOLEAN)",
            second.executionSql,
        )
        assertNotEquals(first.fingerprint, second.fingerprint)
    ...
    @Test
    fun postgresqlSmallintBindingsMaterializeAtSigned16BitBoundaries() {
        val execution = success(
            MaintainedExecutionMaterializer.materialize(
                prepared(
                    sql = "select ?, ?",
                    bindings = listOf(
                        smallintBinding(0, BigInteger.valueOf(Short.MIN_VALUE.toLong())),
                        smallintBinding(1, BigInteger.valueOf(Short.MAX_VALUE.toLong())),
                    ),
                ),
                TargetDialectIdentity("postgresql"),
            ),
        ...
        assertEquals(
            "select CAST(-32768 AS SMALLINT), CAST(32767 AS SMALLINT)",
            execution.executionSql,
        )
    }

    @Test
    fun explicitSmallintJdbcTypeIsAdmitted() {
        val execution = success(
            MaintainedExecutionMaterializer.materialize(
                prepared(
                    sql = "select ?",
                    bindings = listOf(smallintBinding(0, BigInteger.valueOf(42), jdbcType = "SMALLINT")),
                ),
                TargetDialectIdentity("postgresql"),
            ),
        )
    ...
    @Test
    fun mixedBigintSmallintIntegerAndBooleanBindingsPreserveOrderAndFingerprintIdentity() {
        val first = success(
            MaintainedExecutionMaterializer.materialize(
                prepared(
                    sql = "select ?, ?, ?, ?",
                    bindings = listOf(
                        longBinding(0, BigInteger.valueOf(41)),
                        smallintBinding(1, BigInteger.valueOf(42)),
                        integerBinding(2, BigInteger.valueOf(43)),
                        booleanBinding(3, true),
                    ),
                ),
                TargetDialectIdentity("postgresql"),
            ),
        ...
        val second = success(
            MaintainedExecutionMaterializer.materialize(
                prepared(
                    ...
                    bindings = listOf(
                        longBinding(0, BigInteger.valueOf(41)),
                        smallintBinding(1, BigInteger.valueOf(44)),
                        integerBinding(2, BigInteger.valueOf(43)),
                        booleanBinding(3, true),
                    ),
                ),
        ...
        assertEquals(
            "select CAST(41 AS BIGINT), CAST(42 AS SMALLINT), CAST(43 AS INTEGER), CAST(TRUE AS BOOLEAN)",
            first.executionSql,
        )
        assertEquals(
            "select CAST(41 AS BIGINT), CAST(44 AS SMALLINT), CAST(43 AS INTEGER), CAST(TRUE AS BOOLEAN)",
            second.executionSql,
        )
        assertNotEquals(first.fingerprint, second.fingerprint)
    }
    ...
    @Test
    fun bytePreparationAuthorityFailsWithByteSpecificCode() {
        val result = MaintainedExecutionMaterializer.materialize(
            prepared(
                sql = "select ?",
                bindings = listOf(byteBinding(0, BigInteger.valueOf(42))),
                engineVersion = "3.5.20",
            ),
            TargetDialectIdentity("postgresql"),
        )
    ...
    @Test
    fun mixedBigintAndBytePreparationAuthorityFailsWithMixedFamilyCode() {
        val result = MaintainedExecutionMaterializer.materialize(
            prepared(
                sql = "select ?, ?",
                bindings = listOf(
                    longBinding(0, BigInteger.ONE),
                    byteBinding(1, BigInteger.valueOf(2)),
                ),
                engineVersion = "3.5.20",
            ),
            TargetDialectIdentity("postgresql"),
    ...
    @Test
    fun smallintPreparationAuthorityFailsWithSmallintSpecificCode() {
        val result = MaintainedExecutionMaterializer.materialize(
            prepared(
                sql = "select ?",
                bindings = listOf(smallintBinding(0, BigInteger.valueOf(42))),
                engineVersion = "3.5.20",
            ),
            TargetDialectIdentity("postgresql"),
        )
    ...
    @Test
    fun mixedBigintAndSmallintPreparationAuthorityFailsWithMixedFamilyCode() {
        val result = MaintainedExecutionMaterializer.materialize(
            prepared(
                sql = "select ?, ?",
                bindings = listOf(
                    longBinding(0, BigInteger.ONE),
                    smallintBinding(1, BigInteger.valueOf(2)),
                ),
                engineVersion = "3.5.20",
            ),
            TargetDialectIdentity("postgresql"),
    ...
    @Test
    fun byteCrossFamilyIdentityMismatchPreservesLegacyBigintFailureSemantics() {
        val cases = listOf(
            byteBinding(0, BigInteger.ONE, mappingJavaType = "java.lang.Long") to
            ...
            byteBinding(
                0,
                BigInteger.ONE,
                typeHandler = "com.example.CustomByteTypeHandler",
            ) to "materialization-postgresql-bigint-mapping-java-type-unsupported",
        )
    ...
    @Test
    fun unsupportedExactByteMetadataFailsClosedByExactReason() {
        val cases = listOf(
            byteBinding(0, BigInteger.ONE, jdbcType = "SMALLINT") to
                "materialization-postgresql-byte-jdbc-type-unsupported",
            byteBinding(0, BigInteger.ONE, parameterMode = "OUT") to
                "materialization-postgresql-byte-parameter-mode-unsupported",
            byteBinding(0, BigInteger.ONE, numericScale = 0) to
    ...
    @Test
    fun byteMetadataRejectsNonIntegerCoreValue() {
        val result = MaintainedExecutionMaterializer.materialize(
            prepared(
                sql = "select ?",
                bindings = listOf(
                    binding(
                        ...
                        declaredJavaType = "java.lang.Byte",
                        mappingJavaType = "java.lang.Byte",
    ...
    @Test
    fun outOfRangePostgresqlByteFailsClosed() {
        val values = listOf(
            BigInteger.valueOf(Byte.MIN_VALUE.toLong()).subtract(BigInteger.ONE),
            BigInteger.valueOf(Byte.MAX_VALUE.toLong()).add(BigInteger.ONE),
        )

        values.forEach { value ->
            val result = MaintainedExecutionMaterializer.materialize(
                prepared(sql = "select ?", bindings = listOf(byteBinding(0, value))),
                TargetDialectIdentity("postgresql"),
            )
            assertFailure(
                result,
    ...
    @Test
    fun nullByteRemainsOutsideTheMaintainedMatrix() {
        val result = MaintainedExecutionMaterializer.materialize(
            prepared(
                sql = "select ?",
                bindings = listOf(
    ...
    @Test
    fun smallintCrossFamilyIdentityMismatchPreservesLegacyBigintFailureSemantics() {
        val cases = listOf(
            smallintBinding(0, BigInteger.ONE, mappingJavaType = "java.lang.Long") to
                "materialization-postgresql-bigint-type-handler-unsupported",
            smallintBinding(
                0,
                BigInteger.ONE,
            ...
            smallintBinding(
                0,
                BigInteger.ONE,
                typeHandler = "com.example.CustomShortTypeHandler",
            ) to "materialization-postgresql-bigint-mapping-java-type-unsupported",
        )
    ...
    @Test
    fun unsupportedExactSmallintMetadataFailsClosedByExactReason() {
        val cases = listOf(
            smallintBinding(0, BigInteger.ONE, jdbcType = "INTEGER") to
                "materialization-postgresql-smallint-jdbc-type-unsupported",
            smallintBinding(0, BigInteger.ONE, parameterMode = "OUT") to
                "materialization-postgresql-smallint-parameter-mode-unsupported",
            smallintBinding(0, BigInteger.ONE, numericScale = 0) to
    ...
    @Test
    fun smallintMetadataRejectsNonIntegerCoreValue() {
        val result = MaintainedExecutionMaterializer.materialize(
            prepared(
                sql = "select ?",
                bindings = listOf(
                    binding(
                        index = 0,
                        value = InputValue.BooleanValue(true),
                        declaredJavaType = "java.lang.Short",
                        mappingJavaType = "java.lang.Short",
                        typeHandler = "org.apache.ibatis.type.ShortTypeHandler",
                    ),
                ),
            ),
            TargetDialectIdentity("postgresql"),
    ...
    @Test
    fun outOfRangePostgresqlSmallintFailsClosed() {
        val values = listOf(
            BigInteger.valueOf(Short.MIN_VALUE.toLong()).subtract(BigInteger.ONE),
            BigInteger.valueOf(Short.MAX_VALUE.toLong()).add(BigInteger.ONE),
        )

        values.forEach { value ->
            val result = MaintainedExecutionMaterializer.materialize(
                prepared(sql = "select ?", bindings = listOf(smallintBinding(0, value))),
                TargetDialectIdentity("postgresql"),
            )
            assertFailure(
                result,
    ...
    @Test
    fun nullSmallintRemainsOutsideTheMaintainedMatrix() {
        val result = MaintainedExecutionMaterializer.materialize(
            prepared(
                sql = "select ?",
                bindings = listOf(
    ...
    private fun byteBinding(
        index: Int,
        value: BigInteger,
        mappingJavaType: String? = "java.lang.Byte",
        jdbcType: String? = null,
        typeHandler: String = "org.apache.ibatis.type.ByteTypeHandler",
        parameterMode: String = "IN",
        numericScale: Int? = null,
        origin: PreparedBindingOrigin = callerOrigin(index),
    ): PreparedBinding = binding(
    ...
    private fun smallintBinding(
        index: Int,
        value: BigInteger,
        mappingJavaType: String? = "java.lang.Short",
        jdbcType: String? = null,
        typeHandler: String = "org.apache.ibatis.type.ShortTypeHandler",
        parameterMode: String = "IN",
        numericScale: Int? = null,
        origin: PreparedBindingOrigin = callerOrigin(index),
    ): PreparedBinding = binding(
